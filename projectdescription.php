...
$opinfoquery="SELECT userinfo.fname, userinfo.lname, userinfo.defaultpicid, projectmembers.userid
...
{	
	case 0:
		echo "<p style=\"float:right\"><button id=\"joinbutton\" type=\"button\" style=\"font: 24px ;\" onclick=\"window.location = 'addproject.php?id=$projectid';\">+1 Join</button></p>";
		break;
	case 2:
