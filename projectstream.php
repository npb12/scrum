...
$projquery = "SELECT projectname FROM projects WHERE projectid=$projectid";
$projresult=mysql_query($projquery) or die("Unable to query 1!");



echo"
<div id=\"activitystream\">Activity</div>
";
...
$num_rows = mysql_num_rows($commentsresult);
...
<p id=\"procont2\">$rcontent</p>
  ...
  echo "<div id =\"formposts7\"><form method=\"post\" id=\"profdispatch\" action=\"projreply.php?recipient=$commentid&amp;pid=$projectid\" name=\"replys\" onsubmit=\"return validateComment()\">
...
echo"
  <div id=\"comment\">
    <div id =\"pname\"></div>";
  echo "<br>
  <p id=\"nocont\">No current activity</p>";
