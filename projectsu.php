...
FROM projects
WHERE projects.onoff = '0' AND projects.projectname <> ''
...
<form id=\"uniSearchBox\" action=\"searchu.php\" name=\"navsearch\" onsubmit=\"return searchValidate()\" method=\"get\">
...
else
{
  ...
  echo "  <div id=\"opname\"><a href='profile.php?id=$userid' 'alt='$fname $lname's Profile'>$fname $lname</a></div></div>
