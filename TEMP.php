...
<table id =\"body\" width =\"100%\">
	<tbody>
		<tr><td>
<!---Navigation Top--->
<table bgcolor=\"rgba(17, 17, 17, 0.85)\" id=\"navtable\" class='navigationtop' border=\"0\"  width=\"100%\" >
<tbody>
    <tr> <!---Site Logo--->
...
else //Otherwise, display navigation
{
	...
	<button type=\"button\" onclick=\"goToMyFriends();\">My Associates</button>
	<button type=\"button\" onclick=\"goToCreateProject();\">Create Project</button>
	<button type=\"button\" onclick=\"goToMyProjects();\">My Projects</button>
	<button type=\"button\" onclick=\"goToProjects();\">Projects</button>
	<button type=\"button\" onclick=\"goToPrivateProjects();\">Private Projects</button>";
