...
//				var gender = xml_doc.getElementsByTagName('gender')[0].textContent;
				...
				var location = xml_doc.getElementsByTagName('location')[0].textContent;
				var about = xml_doc.getElementsByTagName('about')[0].textContent;
				var work = xml_doc.getElementsByTagName('work')[0].textContent;
				var contact = xml_doc.getElementsByTagName('contact')[0].textContent;
//				var bdate = xml_doc.getElementsByTagName('bdate')[0].textContent;
				
				userHtml += "<tr><td>Email</td><td>" + email + "</td></tr>";
                userHtml += "<tr><td>Location</td><td>" + location + "</td></tr>";
				userHtml += "<tr><td>About</td><td>" + about + "</td></tr>";
				userHtml += "<tr><td>Work</td><td>" + work + "</td></tr>";
				userHtml += "<tr><td>Contact</td><td>" + contact + "</td></tr>";
